		...
		<div class="row">
		  <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
			...
			<div class="card bg-dark text-white">
			  ...
			  <div class="card-img-overlay">
			    <h5 class="card-title"><a href="#">Galle</a></h5>
		  ...
		  <div class="col-lg-4 mb-4 mb-lg-0">
		    <div class="card bg-dark text-white">
			  ...
			  <div class="card-img-overlay">
			    <h5 class="card-title"><a href="#">Kandy</a></h5>
			    <p class="card-text">7+ listing</p>
			  </div>
			</div>
			<div class="card bg-dark text-white">
			  ...
			  <div class="card-img-overlay">
			    <h5 class="card-title"><a href="#">Colombo</a></h5>
			    <p class="card-text">15+ listing</p>
			  </div>
			</div>
		  </div>
		  ...
		  <div class="col-lg-4 mb-4 mb-lg-0">
		    <div class="card bg-dark text-white">
			  ...
			  <div class="card-img-overlay">
			    <h5 class="card-title"><a href="#">Colombo 2</a></h5>
		    ...
		    <div class="card bg-dark text-white">
			  ...
			  <div class="card-img-overlay">
			    <h5 class="card-title"><a href="#">Colombo 1</a></h5>
